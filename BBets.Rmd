...
```{r}
EV=(0.815)*1*26-(1-.815)*1*26
print(EV)
```

Dr.J wins on average 16.38 every time he plays this game
...
To make the bet fair, Dr.J should be paying 4.40
...
```{r}
EV=mean_probs*1*20-(1-mean_probs)*1*20
cat("AverageWin-",EV)
```

If 20 of the 27 students in the class bet, Dr.J's profit or loss would be $5.2

For class size of 23 $1 and $1 is fair as the mean probability is 0.5
